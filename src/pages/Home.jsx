    ...
    return (
        <Layout>
            <div className="min-h-screen flex flex-col">
                ...
                {/* Hero Section */}
                <section ref={heroRef} className="container mx-auto px-6 min-h-[85vh] flex flex-col justify-center items-start pt-16 relative">
                ...
                <section className="py-16 overflow-hidden relative bg-[#e0e5ec]">
                ...
                <section ref={featuresRef} className="py-16 container mx-auto px-6">
                ...
                {/* Vision / Roadmap Section (New) */}
                <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
                    <div className="container mx-auto px-6 relative z-10">
                        <h2 className="text-4xl font-bold text-center mb-16">Future <span className="text-blue-400">Horizons</span></h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-blue-500 transition-colors">
                                ...
                                <h3 className="text-xl font-bold mb-3">Port Pulse Lanes</h3>
                                <p className="text-gray-400 text-sm leading-relaxed">
                                    Exclusive physical infrastructure at major terminals. Dedicated fast-track lanes for algorithm-verified "Green Status" trucks.
                                </p>
                            </div>
                            <div className="p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-purple-500 transition-colors">
                                ...
                                <p className="text-gray-400 text-sm leading-relaxed">
                                    IoT integration to predict engine failures before they happen, preventing breakdowns in active lanes.
                                </p>
                            </div>
                            <div className="p-8 bg-gray-800 rounded-2xl border border-gray-700 hover:border-green-500 transition-colors">
                                ...
                                <h3 className="text-xl font-bold mb-3">Driver Network</h3>
                                <p className="text-gray-400 text-sm leading-relaxed">
                                    Gamified social platform for pilots. Earn badges, share real-time road intel, and build community reputation.
                                </p>
                            </div>
                        </div>
                    </div>
